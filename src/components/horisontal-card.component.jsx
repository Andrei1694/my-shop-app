export default function HorisontalCard() {
  return (
    <div className="flex w-[295px] items-center">
      ...
      <div className="flex flex-col justify-center items-start ml-[16px]">
        <div className="text-nowrap text-base leading-[24px] inline-block">
          "Awaken, My Love!"
        </div>
        <div className="flex flex-row items-center justify-start gap-[8px] text-ui-gray-80">
